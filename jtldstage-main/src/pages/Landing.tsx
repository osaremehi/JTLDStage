    ...
    <div className="public-page overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl public-text-muted max-w-3xl mx-auto">
              From requirements to production code, JTLDstage provides the complete toolkit for standards-driven
      ...
      <section className="py-24 px-6 public-section-gradient">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl public-text-muted max-w-3xl mx-auto">
              JTLDstage is built on <span className="font-semibold public-heading">Context Engineering</span>—the practice of curating rich, structured context that makes AI dramatically more effective. Every artifact, standard, and decision becomes context for better AI output.
            </p>
          </div>
      ...
      <section className="py-24 px-6 public-bg-secondary">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <h2 className="text-4xl font-medium tracking-tight mb-6 public-heading">Why Choose JTLDstage?</h2>
      ...
      <footer role="contentinfo" className="py-12 px-6 public-footer">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-3">
            <JTLDstageLogo className="h-8 w-8 rounded-lg" />
            <span className="text-lg font-semibold tracking-tight public-heading">JTLDstage</span>
          </div>
