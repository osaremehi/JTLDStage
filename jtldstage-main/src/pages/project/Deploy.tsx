...
const Deploy = () => {
  ...
  const cloudDeployments = deployments.filter(d => d.platform === "jtldstage_cloud");
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="flex h-[calc(100vh-4rem)]">
            ...
            <TabsContent value="local" className="space-y-4 mt-4">
              <Card>
                <CardHeader className="pb-3">
                  ...
                  <CardDescription className="text-xs sm:text-sm">
                    Download a real-time syncing package. Files update automatically from JTLDstage with hot reload.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  {isLoading ? (
        ...
        <DeploymentDialog
          ...
          shareToken={shareToken}
          mode="create"
          defaultPlatform={activeTab === "local" ? "local" : "jtldstage_cloud"}
