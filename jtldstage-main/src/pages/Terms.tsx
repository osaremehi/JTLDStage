...
import { JTLDstageLogo } from "@/components/layout/JTLDstageLogo";
    ...
    <div className="public-page">
        ...
        <nav role="navigation" aria-label="Main navigation" className="fixed w-full top-0 z-50 public-nav">
          <div className="max-w-4xl mx-auto px-6 py-4 flex items-center justify-between">
            <Link to="/" className="flex items-center gap-3">
              <JTLDstageLogo className="h-8 w-8 rounded-lg" />
              <span className="text-xl font-semibold tracking-tight public-heading">JTLDstage</span>
      ...
      <main role="main" id="main-content" className="container mx-auto px-6 pt-32 pb-16 max-w-4xl">
        ...
        <p className="text-lg public-text-muted mb-8">
          Please read these terms carefully before using the JTLDstage platform and services.
        </p>
        ...
        <div className="prose max-w-none space-y-6 public-prose">
              ...
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <p>
                    ...
                    and any other artifacts created within or imported to JTLDstage may be deleted without notice. We bear
          ...
          <p>
            By accessing and using the JTLDstage platform, you agree to be bound by these Terms of Use and all applicable
          ...
          <p>
            JTLDstage relies on several third-party services to provide its functionality. By using JTLDstage, you also
      ...
      <footer role="contentinfo" className="py-8 px-6 public-footer">
        <div className="max-w-4xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
          <Link to="/" className="flex items-center gap-3">
            <JTLDstageLogo className="h-6 w-6 rounded-lg" />
            <span className="text-sm font-semibold tracking-tight public-heading">JTLDstage</span>
          </Link>
