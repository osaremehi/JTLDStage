...
const PLANS = [
  ...
  { value: "basic_4gb", label: "Basic 4GB", enabled: true },
  { value: "pro_4gb", label: "Pro 4GB", enabled: true },
  { value: "pro_8gb", label: "Pro 8GB", enabled: true },
  { value: "pro_16gb", label: "Pro 16GB", enabled: true },
