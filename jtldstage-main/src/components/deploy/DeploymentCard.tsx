...
const platformIcons: Record<string, React.ReactNode> = {
  jtldstage_cloud: <Cloud className="h-4 w-4" />,
      ...
      <Card className={cn("border cursor-pointer transition-colors", isSelected && "border-primary ring-2 ring-primary/20")} onClick={onSelect}>
        ...
        <CardContent className="pt-2">
          ...
          <div className="text-xs text-muted-foreground mb-3">
            {deployment.platform === "jtldstage_cloud" && (
            ...
            {deployment.platform === "local" && (
              <div className="space-y-2">
                ...
                <div className="text-xs text-muted-foreground bg-muted/50 rounded p-2 space-y-1">
                  ...
                  <p><strong>.run Only:</strong> <code className="bg-muted px-1 rounded">git clone github.com/jtldstage-red/jtldstage-runner</code> → Drop in .run → <code className="bg-muted px-1 rounded">npm i</code> → <code className="bg-muted px-1 rounded">npm start</code></p>
                </div>
              </div>
            )}
            ...
            {deployment.platform === "local" && (
              <>
                ...
                <Button 
                  ...
                  title="Download .run config file only (use with jtldstage-runner git clone)"
                >
