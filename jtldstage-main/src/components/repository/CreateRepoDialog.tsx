...
export function CreateRepoDialog({
  ...
  const [templateOrg, setTemplateOrg] = useState("jtldstage-cloud");
  ...
  const handleCreateFromTemplate = () => {
    if (templateName.trim() && templateOrg.trim() && templateRepo.trim()) {
      ...
      setOpen(false);
      setTemplateName("");
      setTemplateOrg("jtldstage-cloud");
      setTemplateRepo("");
        ...
        <Tabs defaultValue="empty">
          ...
          <TabsContent value="empty" className="space-y-4">
            <div className="space-y-2">
              ...
              />
              <p className="text-sm text-muted-foreground">Will be created in jtldstage-cloud organization</p>
            </div>
