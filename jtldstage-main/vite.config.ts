...
export default defineConfig(({ mode }) => ({
  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: "JTLDstage - AI-Powered Enterprise Application Platform",
        short_name: "JTLDstage",
        description: "Transform unstructured requirements into traceable, compliant applications with JTLDstage's standards-first, agentic AI platform.",
        theme_color: "#0a0a0a",
