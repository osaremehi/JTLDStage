...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    const baseUrl = "https://jtldstage.red";
    ...
    if (type === 'signup') {
      ...
      subject = "Verify your JTLDstage account";
      heading = "Welcome to JTLDstage!";
      ...
      subject = "Reset your JTLDstage password";
              ...
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                ...
                <tr>
                  <td style="padding: 40px;">
                    ...
                    ${type === 'signup' ? `
                    <p style="margin: 24px 0 0; color: #6b7280; font-size: 14px; line-height: 1.6;">
                      If you didn't create a JTLDstage account, you can safely ignore this email.
                    </p>
                    ` : `
                    <p style="margin: 24px 0 0; color: #6b7280; font-size: 14px; line-height: 1.6;">
                      ...
                      <tr>
                        <td style="text-align: center;">
                          <p style="margin: 0 0 8px; color: #6b7280; font-size: 14px;">
                            <a href="${baseUrl}" style="color: #dc2626; text-decoration: none; font-weight: 500;">jtldstage.red</a>
                          </p>
                          <p style="margin: 0; color: #9ca3af; font-size: 12px;">
                            © ${new Date().getFullYear()} JTLDstage. All rights reserved.
                          </p>
    ...
    const emailResponse = await resend.emails.send({
      from: "JTLDstage <info@jtldstage.red>",
      to: [email],
      subject: subject,
      html: htmlContent,
    });
