...
function getDocumentationHtml(): string {
  const endpoint = "https://api.jtldstage.red/functions/v1/ingest-artifacts";
...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>JTLDstage Artifact Ingest API</title>
  <style>
...
<body>
  <div class="container">
    <h1>🦌 JTLDstage Artifact Ingest API</h1>
    <p class="subtitle">Webhook endpoint to ingest text and images into your JTLDstage projects</p>
...
response = requests.post(
  ...
  "processingTimeMs": 234
    ...
    <div class="info">
      ...
      Visit <a href="https://jtldstage.red">jtldstage.red</a> to manage your projects and get your project ID and access tokens.
    </div>
  </div>
</body>
</html>`;
